...
const SubNav: React.FC<SubNavProps> = ({ selectedCategory, onCategoryClick }) => {
  ...
  return (
    <div className="sticky top-16 z-40 bg-white/90 backdrop-blur-md border-b border-sofab-blue/30">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-sm transition-colors duration-200 border ${
                  selectedCategory === 'all'
                    ? 'bg-sofab-pink text-white border-sofab-pink'
                    : 'bg-white text-sofab-charcoal border-gray-300 hover:border-sofab-pink hover:text-sofab-pink'
                }`}
              >
                All
              </button>
